...
if __name__ == "__main__":
    ...
    # 攻击的模型地址
    model_name = f'bert-base-uncased-snli-adv-multi'
    args.model_from_file = './models/snli_adv_multi.py'
    args.parallel = True
    # 保存结果文件
    args.log_to_csv = '{}/{}-test-adv-multi.csv'.format(model_name, args.recipe)
