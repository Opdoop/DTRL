...
class WordSwapMaskedLM(WordSwap):
    ...
    Choose which method to use by specifying "bae" or "bert-attacks" for `method` argument.

    Args:
        method (str): the name of replacement method (e.g. "bae", "bert-attacks")
