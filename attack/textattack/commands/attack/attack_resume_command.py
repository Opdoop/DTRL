...
class AttackResumeCommand(TextAttackCommand):
    """The TextAttack attacks resume recipe module:

    A command line parser to resume a checkpointed attacks from user
    specifications.
    """
    ...
    def register_subcommand(main_parser: ArgumentParser):
        resume_parser = main_parser.add_parser(
            "attacks-resume",
            help="resume a checkpointed attacks",
        ...
        resume_parser.add_argument(
            ...
            type=str,
            required=True,
            help='Path of checkpoint file to resume attacks from. If "latest" (or "{directory path}/latest") is entered,'
