...
class AttackCommand(TextAttackCommand):
    """The TextAttack attacks module:

    A command line parser to run an attacks from user specifications.
    """
    ...
    def register_subcommand(main_parser: ArgumentParser):
        parser = main_parser.add_parser(
            "attacks",
            help="run an attacks on an NLP model",
        ...
        parser.add_argument(
            ...
            help='Constraints to add to the attacks. Usage: "--constraints {constraint}:{arg_1}={value_1},{arg_3}={value_3}". Choices: '
        ...
        parser.add_argument(
            ...
            const="",
            type=str,
            help="Save attacks logs to <install-dir>/outputs/~ by default; Include '/' at the end of argument to save "
        ...
        parser.add_argument(
            ...
            action="store_true",
            default=False,
            help="Whether to run attacks until `n` examples have been attacked (not skipped).",
        )
        ...
        parser.add_argument(
            ...
            action="store_true",
            default=False,
            help="Run attacks using multiple GPUs.",
        )
        ...
        attack_group.add_argument(
            ...
            required=False,
            default=None,
            help="full attacks recipe (overrides provided goal function, transformation & constraints)",
        ...
        attack_group.add_argument(
            ...
            required=False,
            default=None,
            help="attacks to load from file (overrides provided goal function, transformation & constraints)",
        )
