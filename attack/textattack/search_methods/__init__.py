...
Search methods explore the transformation space in an attempt to find a successful attacks as determined by a :ref:`Goal Functions <goal_function>` and list of :ref:`Constraints <constraint>`
"""
