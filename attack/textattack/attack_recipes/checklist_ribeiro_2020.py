...
class CheckList2020(AttackRecipe):
    """An implementation of the attacks used in "Beyond Accuracy: Behavioral
    Testing of NLP models with CheckList", Ribeiro et al., 2020.

    This attacks focuses on a number of attacks used in the Invariance Testing
    ...
    def build(model):
        ...
        # Untargeted attacks & GreedySearch
