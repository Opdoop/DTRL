...
class BERTAttackLi2020(AttackRecipe):
    ...
    This is "attacks mode" 1 from the paper, BAE-R, word replacement.
    """
    ...
    def build(model):
        ...
        transformation = WordSwapMaskedLM(method="bert-attacks", max_candidates=48)
        #
        ...
        # preservation and attacks success rate, we set up a threshold of semantic
