...
class FasterGeneticAlgorithmJia2019(AttackRecipe):
    ...
    def build(model):
        ...
        # This results in a hard-to-define attacks surface, as
        ...
        # attacks, which is inefficient. Moreover, the same
        ...
        # adjustment, so does not affect the attacks recipe.]
        #
        # Appendix A.3:
        #
        ...
        # hard-to-define attacks surface, as the same word can be replaced many
