...
class Pruthi2019(AttackRecipe):
    """An implementation of the attacks used in "Combating Adversarial
    Misspellings with Robust Word Recognition", Pruthi et al., 2019.

    This attacks focuses on a small number of character-level changes that simulate common typos. It combines:
