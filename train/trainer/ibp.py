...
class IBPTrainer(BaseTrainer):
    ...
    def add_args(parser):
        ...
        # group.add_argument('--use-lm', action='store_true', help='Use LM scores to define attacks surface')
        # Training
        ...
        group.add_argument('--cert-eps', type=float, default=1.0,
                           help='Max scaling factor for the interval bounds of the attacks words to be used')
