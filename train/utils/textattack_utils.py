...
from datasets_wrapper.reader import BaseReader, ClassificationReader
...
def build_english_attacker(args: ProgramArgs, model: HuggingFaceModelWrapper) -> Attack:
    ...
    if args.attack_method == 'pwws':
        ...
        attacker.transformation = WordSwapMaskedLM(method="bert-attacks", max_candidates=args.neighbour_vocab_size)
